...
export default function TeamElementBig({data : {image, name, description, path, color}} : {data: TeamDataType}){
    ...
    const children =    <>
                        ...
                        <Stack justify={isSmallDevice ? "center" : "flex-start"} mt={30}>
    ...
    return(
        <>
            <MediaQuery smallerThan="lg" styles={{justifyContent: "flex-start"}}>
                <Flex justify="center" align={isSmallDevice? "center" : "flex-start"} wrap="nowrap" direction={isSmallDevice?"column" : "row"} mt={40}>
                    {children}
                </Flex>
            </MediaQuery>
